...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    /**
     * Returns the group of libraries at dotlottie
     */
    ...
    public static class DotlottieLibraryAccessors extends SubDependencyFactory {
        ...
        public DotlottieLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
            ...
            /**
             * Creates a dependency provider for android (com.github.LottieFiles:dotlottie-android)
             * This dependency was declared in catalog libs.versions.toml
             */
    ...
    public static class FirebaseDatabaseLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Returns the group of libraries at firebase.database.ktx
         */
    ...
    public static class FirebaseDatabaseKtxLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        public FirebaseDatabaseKtxLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
            ...
            /**
             * Creates a dependency provider for v2031 (com.google.firebase:firebase-database-ktx)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getV2031() {
                return create("firebase.database.ktx.v2031");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        public VersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: dotlottieAndroid (0.2.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getDotlottieAndroid() { return getVersion("dotlottieAndroid"); }
            ...
            /**
             * Returns the version associated to this alias: firebaseAnalyticsKtx (22.0.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: firebaseCrashlyticsKtx (19.0.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: firebaseDatabaseKtxVersion (21.0.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: firebaseUiStorage (8.0.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: hutoolCore (5.8.26)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getHutoolCore() { return getVersion("hutoolCore"); }

            /**
             * Returns the version associated to this alias: jacksonDatabind (2.14.1)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: retrofit2KotlinxSerializationConverter (0.8.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
